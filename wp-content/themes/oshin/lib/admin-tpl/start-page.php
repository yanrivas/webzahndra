...
<header class="be-start-header">
   <div class="header-wrapper clearfix">
    ...
    <div class="c-9"><h1><?php esc_html_e( 'Welcome to ', 'oshin' ); ?><?php echo esc_html($BECore['themeName']); ?></h1>
<p>Thank you for purchasing and using <?php echo esc_html($BECore['themeName']); ?>.To Get started quickly, please install all the required and recommended plugins and import a demo of your choice. <?php if( !defined('ENVATO_HOSTED_SITE')  ) : ?> Register your license and enjoy automatic theme updates. For information regarding using the theme, please refer our <a href="<?php echo esc_html($BECore['documentation']); ?>" target="_blank">online knowledgebase.</a><?php endif; ?></p>
...
<section class="be-start-content">
	...
	<p><?php esc_html_e( 'Getting started with Oshine is pretty simple just follow the below steps:', 'oshin' ); ?>
	<ol>
		<?php if( !defined('ENVATO_HOSTED_SITE')  ) : ?>
		...
		<li><?php esc_html_e( 'Import any of the demo content by going to ', 'oshin' ) ?><a data-tab="be-import" href="#">Import</a></li>
