...
.hero-section-blog-categories-wrap a:hover {
   font-size : calc(<?php echo $be_themes_data[ 'post_top_meta_options' ][ 'font-size' ] ; ?> + 2px );
   font-weight : <?php echo $be_themes_data[ 'post_top_meta_options' ][ 'font-weight' ] ; ?>;
   font-family : <?php echo $be_themes_data[ 'post_top_meta_options' ][ 'font-family' ]; ?>;
   line-height : <?php echo $be_themes_data[ 'post_top_meta_options' ][ 'line-height' ]; ?>;
   letter-spacing : <?php echo $be_themes_data[ 'post_top_meta_options' ][ 'letter-spacing' ]; ?>;
   text-transform : <?php echo $be_themes_data[ 'post_top_meta_options' ][ 'text-transform' ]; ?>;    
   color : <?php echo ( ( isset( $be_themes_data[ 'single_post_typo' ] ) && !empty( $be_themes_data[ 'single_post_typo' ] ) ) ?  $be_themes_data[ 'single_post_title' ][ 'color' ] : $be_themes_data[ 'post_title' ][ 'color' ] ); ?>;
}
.hero-section-blog-bottom-meta-wrap {
   font-size : calc(<?php echo $be_themes_data[ 'post_meta_options' ][ 'font-size' ]; ?> + 2px );
   font-weight : <?php echo $be_themes_data[ 'post_meta_options' ][ 'font-weight' ] ; ?>;
   font-family : <?php echo $be_themes_data[ 'post_meta_options' ][ 'font-family' ]; ?>;
   line-height : <?php echo $be_themes_data[ 'post_meta_options' ][ 'line-height' ]; ?>;
   letter-spacing : <?php echo $be_themes_data[ 'post_meta_options' ][ 'letter-spacing' ]; ?>;
   text-transform : <?php echo $be_themes_data[ 'post_meta_options' ][ 'text-transform' ]; ?>;
   color : <?php echo ( ( isset( $be_themes_data[ 'single_post_typo' ] ) && !empty( $be_themes_data[ 'single_post_typo' ] ) ) ?  $be_themes_data[ 'single_post_title' ][ 'color' ] : $be_themes_data[ 'post_title' ][ 'color' ] ); ?>;    
}
...
.accordion .accordion-head.with-bg.ui-accordion-header-active{
  background-color: <?php echo $be_themes_data['color_scheme']; ?> !important;
  color: <?php echo $be_themes_data['alt_bg_text_color']; ?> !important;
}
.skill-wrap .skill_name{
...
?>
  ...
  .overlay-left-align-menu .be-overlay-menu-close{
    bottom : <?php 
      echo ( 60 - ( isset( $be_themes_data['sidebar_menu_text']['line-height'] )  ? $be_themes_data['sidebar_menu_text']['line-height'] : 0 ) / 2 ).'px' ;
    ?>;
    left: <?php //Font size of the icon is freezed as 30px. Total width comes as 31px. Hence half of it to be subtracted from half of strip width
      echo ( ( ( ( isset( $be_themes_data['left_special_strip_width'] ) && !empty( $be_themes_data['left_special_strip_width'] ) ) ? $be_themes_data['left_special_strip_width'] : 70 ) / 2 ) - ( 31 / 2 ) ).'px';
      ?>;
  }
  .admin-bar.overlay-left-align-menu .be-overlay-menu-close{
    bottom : <?php 
      echo ( 92 - ( isset( $be_themes_data['sidebar_menu_text']['line-height'] )  ? $be_themes_data['sidebar_menu_text']['line-height'] : 0 ) / 2 ).'px' ;
    ?>;
  }
  <?php 
