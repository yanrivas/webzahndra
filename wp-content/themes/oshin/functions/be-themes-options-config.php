           ...
           $portfolio_grid_styles = array(
            ...
            $this->sections[] = array (
                ...
                'fields' => array (  
                    ...
                    array(
                        'id'        => 'opt-portfolio-details-start',
                        'type'      => 'section',
                        'title'     => 'Portfolio Details Typography',
                        'subtitle'  => __('Title and Contents in Portfolio Details Module in Single Portfolio Pages','oshin'),
                        'indent'    => true, // Indent all options below until the next 'section' option is set.
                    ),
                        array(
