	            ...
	            array (
				  ...
				  'selectors' => array(
					    '.tatsu-{UUID} .tatsu-section-pad' => array(
							'property' => 'padding',
							'when' => array('padding', '!=', '0px 0px 0px 0px' ),
						),
					)
	            ),
	            array (
				  ...
				  'selectors' => array(
					    '.tatsu-{UUID}.tatsu-section' => array(
							'property' => 'margin',
							'when' => array('margin', '!=', '0px 0px 0px 0px' ),
						),
					),
	            ),		            	             
	            array (
					...
					'css' => true,
				  	'selectors' => array(
					    '.tatsu-{UUID} .tatsu_testimonial_role' => array(
							'property' => 'color',
							'when' => array(
								array('author_role_color', 'notempty')
							),
						),
					),
	            ),
	...
	$controls = array(
        ...
        'drag_handle' => false,
            ...
            array(
				...
				'css' => true,
				'selectors' => array(
					'.tatsu-{UUID}.tatsu-single-image img' => array(
						'property' => 'border-width',
						'append' => 'px',
					),
				),
